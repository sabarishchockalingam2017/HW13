package com.example.sabarish.colorcamera;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        threshView = (TextView) findViewById(R.id.threshText);
        threshControl = (SeekBar) findViewById(R.id.threshSeek);
    ...
    private void setMyControlListener() {
        threshControl.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                threshView.setText("The value is: "+progress);
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            int thresh = threshControl.getProgress()/5; // comparison value
